...
namespace Saylo.Centrex.Infrastructure.Localization.JsonConfig
{
    public class JsonStringLocalizer : IStringLocalizer
    {
        ...
        private string GetTranslation(string key)
        {
            ...
            return languageTranslations.TryGetValue(key, out var translation) ? translation : key;
        }

        private string GetLanguageCode()
        {
            if (_requestLocalizationOptions == null || _httpContextAccessor == null) return "fr-FR";
